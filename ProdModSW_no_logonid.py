...
def data_gen(start_date,numdays):
    ...
    while i <= numdays:
            ...
            #continue
        #else:
        dayurl = './output_2/data_security_' + day + '.txt'
...
while testdate <= '20160424':
    ...
    parallel_model.fit(x_train, y_train, epochs = 3, verbose = 1, batch_size = 64, callbacks = [early_stopping])
